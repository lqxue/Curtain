 ...
 * @author lqx
 */
public class GuideFragmentViewWrapper implements IGuide {
    ...
    private CurtainInflateFragmentView.CallBack callBack;
...
//        }
    ...
    public void setCallBack(CurtainInflateFragmentView.CallBack callBack) {
